...
estabelecido pelo regulamento do estado de São Paulo (50 quilos) deve pagar um
...
programa
{
	...
	funcao inicio(){
		...
		real pesoTomates, excessoPeso = 0.0 , multa = 0.0
		...
		senao {
			escreva("Não ocorreu excedente \n")
			}

		escreva("O peso comprado é: ", pesoTomates," Kg \n")
		escreva("O peso execedente é: ", excessoPeso," Kg \n")
		escreva("valor da multa é: R$ ", multa)
	}
}
/* $$$ Portugol Studio $$$ 
 * 
